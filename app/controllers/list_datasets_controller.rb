...
class ListDatasetsController < ApplicationController
  ...
  ListDatasetsController.solr_search_params_logic = CatalogController.solr_search_params_logic - [:add_advanced_parse_q_to_solr, :add_advanced_search_to_solr]
  # Add query filter
  ...
  def exclude_unwanted_models solr_parameters, user_parameters
    ...
    solr_parameters[:fq] << "active_fedora_model_ssi:Dataset"
  end
